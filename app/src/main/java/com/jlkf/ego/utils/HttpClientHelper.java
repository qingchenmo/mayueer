...
/**
 * http://blog.csdn.net/chenzhiqin20/article/details/21738521
 * 网络连接类 	封装了一个httpclient帮助类
 * @author  邓超桂
 * @E-mail  305436934@qq.com 
 *@创建时间 2016年12月6日 下午4:02:43
 */
	        ...
	        if (null == httpClient) {  
	            ...
	            try {  
	                ...
	                HttpProtocolParams.setUserAgent(httpParams, String  
	                        .format("thinkandroid/%s (http://a.yuxingqiu.com)",  
	                                VERSION));
...
//	                httpClient = new AsyncHttpClient(conManager, httpParams);  
