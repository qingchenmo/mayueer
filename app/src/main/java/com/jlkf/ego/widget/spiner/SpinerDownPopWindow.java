...
public class SpinerDownPopWindow extends PopupWindow implements OnItemClickListener{
	...
	public SpinerDownPopWindow(Context context)
	{
		super(context);
	...
	private void init()
	{
		View view = LayoutInflater.from(mContext).inflate(R.layout.spiner_window_layout_down, null);
		setContentView(view);		
