 ...
 * <p>to compress the mData before encoding it and then making the output have newline characters.</p>
 * <p>Also...</p>
 ...
 *   final encoded mData will be so that the code doesn't have to create two output
 ...
 *   encoded mData was a single byte.</li>
 *  <li>v2.0 - I got rid of methods that used booleans to set options. 
 *   Now everything is more consolidated and cleaner. The code now detects
 *   when mData that's being decoded is gzip-compressed and will decompress it
 ...
 *   mData in an otherwise "normal" stream (like an XML file).</li>
...
public class Base64 {
	...
	/** Specify that mData should be gzip-compressed in second bit. Value is two. */
	public final static int GZIP = 2;

	/**
	 * Specify that gzipped mData should <em>not</em> be automatically gunzipped.
	 */
	 ...
	 * mData encoded this way is <em>not</em> officially valid Base64, or at the
	...
	/**
	 * Encodes a byte array into Base64 notation. Does not GZip-compress mData.
	 * 
	 * @param source
	 *            The mData to convert
	 * @return The mData in Base64-encoded form
	 * @throws NullPointerException
	 ...
	 * @param options
	 *            Specified options
	 * @return The Base64-encoded mData as a String
	 * @see Base64#GZIP
	 * @see Base64#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 ...
	 * I/O streams and have large mData sets to encode.
	 * 
	 * 
	 * @param source
	 *            The mData to convert
	 * @return The Base64-encoded mData as a byte[] (of ASCII characters)
	 * @throws NullPointerException
	 *             if source array is null
	 * @since 2.3.1
	 */
	 ...
	 * working with I/O streams and have large mData sets to encode.
	 * 
	 * 
	 * @param source
	 *            The mData to convert
	 ...
	 * 
	 * @param source
	 *            The Base64 encoded mData
	 * @return decoded mData
	 * @since 2.3.1
	 */
	 ...
	 * @return decoded mData
	 * @throws java.io.IOException
	 *             If bogus characters exist in source mData
	 * @since 1.3
	 */
	...
	/**
	 * Decodes mData from Base64 notation, automatically detecting
	 * gzip-compressed mData and decompressing it.
	 * 
	 * @param s
	 *            the string to decode
	 * @return the decoded mData
	 * @throws java.io.IOException
	...
	/**
	 * Attempts to decode Base64 mData and deserialize a Java Object within.
	 * Returns <tt>null</tt> if there was an error.
	 * 
	 * @param encodedObject
	 *            The Base64 mData to decode
	...
	/**
	 * Convenience method for encoding mData to a file.
	 * 
	 * <p>
	 ...
	 * 
	 * @param dataToEncode
	 *            byte array of mData to encode in base64 form
	 * @param filename
	 *            Filename for saving encoded mData
	 * @throws java.io.IOException
	 *             if there is an error
	 * @throws NullPointerException
	...
	/**
	 * Convenience method for decoding mData to a file.
	 * 
	 * <p>
	 * As of v 2.3, if there is a error, the method will throw an
	 * java.io.IOException. <b>This is new to v2.3!</b> In earlier versions, it
	 ...
	 * 
	 * @param dataToDecode
	 *            Base64-encoded mData as a string
	 * @param filename
	 *            Filename for saving decoded mData
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.1
	 */
	 ...
	 * 
	 * @param filename
	 *            Filename for reading encoded mData
	 ...
	 * 
	 * @param filename
	 *            Filename for reading binary mData
	...
	/**
	 * A {@link InputStream} will read mData from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		private byte[] buffer; // Small buffer holding converted mData
		 ...
		 * 
		 * @param in
		 *            the <tt>java.io.InputStream</tt> from which to read mData.
		 * @since 1.3
		 */
		 ...
		 * 
		 * <pre>
		 *   ENCODE or DECODE: Encode or Decode as mData is read.
		 *   DO_BREAK_LINES: break lines at 76 characters
	...
	/**
	 * A {@link OutputStream} will write mData to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		 ...
		 * 
		 * @param out
		 *            the <tt>java.io.OutputStream</tt> to which mData will be
		 *            written.
		 * @since 1.3
		 */
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					throw new java.io.IOException(
							"Invalid character in Base64 mData.");
		 ...
		 * a piece of base64-encoded mData in a stream.
		 * 
		 * @throws java.io.IOException
		 ...
		 * piece of base64-encoded mData in a stream.
		 * 
		 * @since 1.5.1
		 */
